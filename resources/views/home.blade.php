                        ...
                        <div class="row">
                              ...
                              <div class="border border-1 border-dark rounded-3 p-0 my-2">
                                    ...
                                    <div class="border-bottom border-dark d-flex justify-content-center p-3 gap-3">
                                          ...
                                          <a href="{{route('ceritificates.download-all-certificates','1 - 50')}}"><i class="bi bi-cloud-arrow-up-fill btn btn-primary px-2 py-1 text-light" style="font-size:13px;">  1 - 50</i></a>
                                          <a href="{{route('ceritificates.download-all-certificates','51 - 100')}}"><i class="bi bi-cloud-arrow-up-fill btn btn-primary px-2 py-1 text-light" style="font-size:13px;">  51 - 100</i></a>
